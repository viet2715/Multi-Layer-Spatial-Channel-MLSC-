...
import os
from Function.function import seed_func, cal_accuracy_fewshot_1shot
...
if args.dataset == 'PDB':
    ...
    x_train, x_test, y_train, y_test = train_test_split(data, label, test_size=0.2, random_state=42, stratify=label) # seed value = 42
    test_size = args.training_samples_PDB/x_train.shape[0]
    _, x_train_limited,_, y_train_limited = train_test_split(x_train, y_train, test_size=test_size, random_state=42, stratify=y_train) # seed value = 42
